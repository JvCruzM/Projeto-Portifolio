export default function Sobre() {
  return (
    <div className="space-y-6">
      <h1 className="text-4xl font-bold border-b border-gray-700 pb-2">Sobre Mim</h1>
      ...
      <h2 className="text-2xl font-semibold mt-8 text-blue-400">Tecnologias utilizadas neste Portfólio</h2>
      <ul className="list-disc list-inside bg-gray-800 p-6 rounded-lg text-gray-300 shadow-lg">
